      ...
      <div className="max-w-6xl mx-auto">
        <Card className="p-6 md:p-8">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-4 gap-6">
            <div className="lg:col-span-3 w-full aspect-square bg-surface rounded-lg flex items-center justify-center border-2 border-dashed border-border-color relative overflow-hidden">
                ...
                {isImageLoaded && activeImage && (
                  <div className="absolute bottom-4 right-4 flex gap-2">
                    <Button onClick={() => handleReusePrompt(activeImage)} className="!p-3 !bg-surface hover:!bg-border-color/50 !text-text-primary" title="Use this prompt and settings to generate a new image">
                    ...
                    <Button onClick={() => setFullscreenImage(activeImage)} className="!p-3" title="View fullscreen">
                    ...
                    <Button onClick={handleDownload} className="!p-3" title="Download image">
                ...
                {imageHistory.map((img) => (
                  <div key={img.url} className="relative group aspect-square">
                    ...
                    <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity flex items-center justify-center gap-2">
                        <button
                            onClick={(e) => { e.stopPropagation(); handleReusePrompt(img); }}
